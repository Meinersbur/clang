...
int main(int argc, char **argv) {
  ...
  #pragma omp parallel private (argc)
  #pragma omp parallel private (S1) // expected-error {{'S1' does not refer to a value}}
  #pragma omp parallel private (a, b, c, d, f) // expected-error {{private variable with incomplete type 'S1'}} expected-error 3 {{shared variable cannot be private}}
  ...
  #pragma omp parallel private(h) // expected-error {{threadprivate or thread local variable cannot be private}}
